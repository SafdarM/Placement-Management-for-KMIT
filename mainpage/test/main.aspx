...
<body runat="server" id="body" class="bg-img" >
    ...
    <div>
    <div class="tile-area bg-darkBlue fg-white" style="padding-top:5px;height:123px">
        <div class="image-container" style="width:300px;height:110px;float:left;padding-right:10px;">
        <img src="../css/kmit/kmit logo.gif" /></div>
...
<div class="tile-area-controls" style="float:right;position:absolute; width:150px; right :20px; top:60px;">
 <span class="icon mif-user"></span>   <asp:Label ID="Label1" runat="server" Text=""></asp:Label> 
              <a href="NewFolder1/main.aspx" style="color:white;"><span class=" mif-exit"> logout</span></a>       
        </div>
    </div>
        
        <div>
            <div style="float:left;width:220px;">
                <ul class="sidebar tile-area-scheme-dark compact " id="sidebar-2">
                            <li><a href="#">
                            ...
                            <li><a href="#">
                                <span class=" mif-chart-bars2 icon"></span>
    ...
    <div class="tile-content">
        ...
        <div class="carousel " data-role="carousel" data-controls="false" data-markers="false" data-effect="fade">
    <div class="slide"><img alt="" src="../css/kmit/DSC_0082.jpg" /></div>
    <div class="slide"><img alt="" src="../css/kmit/1.png" /></div>
            <div class="slide"><img alt="" src="../css/kmit/11.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/2.png" /></div>
            <div class="slide"><img alt="" src="../css/kmit/3.png" /></div>
            <div class="slide"><img alt="" src="../css/kmit/6.png" /></div>
            <div class="slide"><img alt="" src="../css/kmit/8.png" /></div>
            <div class="slide"><img alt="" src="../css/kmit/9.png" /></div>

            <div class="slide"><img alt="" src="../css/kmit/DSC_00847.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/DSC_00876.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/DSC_0104.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/DSC_0108.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/DSC_0152.jpg" /></div>
            <div class="slide"><img alt="" src="../css/kmit/DSC_0153.jpg" /></div>
...
<%--        <div class="image-container">
            ...
            <span class="tile-label" style="bottom:5px">About us</span>
</div> </a>
    ...
    <div class="tile-content">
        <div class=" tile-content iconic"><span class="icon mif-2x mif-profile"></span> </div> 
    </div>
       <span class="tile-label">KMITRA</span>
</div> </a>

            <a href="#" style="color:white"> <div class=" tile bg-violet" data-role="tile" data-effect="slideUpDown">
               
    <div class="tile-content image-container" style="height:150px">
        <img alt="" src="../css/kmit/scroll.jpg" />
        <div class="live-slide" style="padding:17px;color:black;"><br /> College for second years opens from 2-07-2015. </div>
        <div class="live-slide " style="padding:17px;color:black;"><br /> college timings for 3rd year students are from 9:30 A.M to 4:15 P.M  </div>
        <div class="live-slide" style="padding:17px;color:black;"><br /> orientation for first year students is to be held on 1st august at 9:30 A.M  </div>  
    </div>
            <span class="tile-label fg-black">Notifications</span>
</div> </a>
...
<a href="#" style="color:white"> <div class="tile bg-lightGreen" data-role="tile" data-effect="slideUpDown">
    <div class="tile-content">
        <div class=" tile-content iconic"><span class="icon mif-school"></span> </div> 
    </div>
       <span class="tile-label">Finishing School</span>
</div> </a>

           

<a href="#" style="color:white"> <div class="tile bg-orange" data-role="tile" data-effect="slideUpDown">
    <div class="tile-content">
        <div class=" tile-content iconic"><span class="icon mif-medal"></span> </div> 
    </div>
       <span class="tile-label">Trishul</span>
</div> </a>
    ...
    <div class="tile-group double" >
        ...
        <div class=" tile-content iconic " style="color:white"><span class="icon mif-twitter"></span> </div> 
            ...
            <a href="https://plus.google.com/u/0/109796373994268564150/about">
             <div class=" tile-small bg-red" data-role="tile" data-effect="slideUpDown">
                 <div class="tile-content">
...
y,+Andhra+Pradesh&amp;t=m&amp;ll=17.397119,78.490289&amp;spn=0.006295,0.006295" target="_blank">  <div class=" tile-small bg-emerald" data-role="tile" data-effect="slideUpDown">
    <div class="tile-content">
        ...
        <div style="position:absolute; float:right;top:440px;left:1025px">
