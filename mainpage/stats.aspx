<%@ Page Title="" Language="C#" MasterPageFile="~/mainpage/nomenumain.master" AutoEventWireup="true" CodeFile="stats.aspx.cs" Inherits="general_stats" %>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td>
                :</td>
            <td>
                <asp:DropDownList ID="year" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass=" input-control text" ToolTip="Select the Year to get the Statastical Data!">
            ...
            <td>
                :</td>
            <td>
                <asp:DropDownList ID="companylist" runat="server" AutoPostBack="True"  OnSelectedIndexChanged="companylist_SelectedIndexChanged" CssClass=" input-control text" ToolTip="Select the Company to get the Statastical Data!"  >
                </asp:DropDownList>
            </td>
            <td>
                graph type</td>
            <td>
                :</td>
            <td>
                <asp:DropDownList ID="charttype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="charttype_SelectedIndexChanged" CssClass=" input-control text" ToolTip="Select the Type of Graph!">
